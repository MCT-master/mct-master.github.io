...
The concert took place at two separate locations at [IMV](https://www.hf.uio.no/imv/english/) (Institute of Musicology) on December 3rd, 2021. Our team was based in our much beloved Portal(insert link), while the other team and audience were situated in Salen(insert link or picture).
...
Once we were set to go and the lights were on, we did experience some transfer issues resulting in a lot of clipping and noise from the downstairs audio stream. We crossed our fingers that our stream passed through more fluidly the other way, and started playing. After a few minutes the quality of the sound improved, and it was a lot more rewarding as an improvisational experience. Some interesting textures were created, and it felt quite natural to perform together although not located in the same room. The rhythms were mainly instigated from Salen, and there were never any issues with latency in regard to playing along to the rhythmic structures. We had opted not to use any midi clock or other synchronization tools, so all delay effects and rhythmic components had to be done by ear, which is always interesting when working with electronic music.
...
<figcaption>Full concert.</figcaption>
</figure>
https://www.youtube.com/embed/-dnpzsVc32M

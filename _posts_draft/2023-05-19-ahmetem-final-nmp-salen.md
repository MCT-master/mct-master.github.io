...
For this telematic experience, as MCT Students, we contributed an improvisational performance conducted in US and performed in more than four countries.
...
## Audio Engineering
Audio routing for this project meant allowing for a FOH stereo mix for our local audience, three foldback mixes for locall musicians, as well as sending a stereo sub-mix of our instruments to the Jacktrip server.  The plot below shows the routing used.
...
Despite this mode of improvisational performance being outside the experience of many of the class, it was both technically and musically executed to a standard we were pleased with.  We participated in the event without technical mishap.

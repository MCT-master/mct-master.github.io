...
2. [Post Layout and Placement](#post-layout-and-placement)
   i. [Folders](#folders)
   ii. [File name](#file-name)
   iii. [Frontmatter](#frontmatter)
3. [Embedding Multi-media](#embedding-multi-media)
   i. [Links](#links)
   ii. [Images](#images)
   iii. [Slideshow](#slideshow)
   iv. [Videos](#videos)
   v. [Audio](#audio)
4. [Tables](#tables)
   i. [Standard HTML Tables](#standard-html-tables)
   ii. [Responsive HTML Tables](#responsive-html-tables)
   iii. [Markdown Tables](#markdown-tables)

---
layout: post
title:  "Advanced collaborative spaces and tele-immersive systems"
...
'Nidarø Sulpture', a dynamic vision and audio sculpture. Both approaches contain his main research areas on tele-immersive collaboration 
systems and low latency networks. While the Nidarøs Sculpture is an architectural all encompassing concept that is presented in a artistic 
manner including the sonification of the means of presentation, a short clip, the scientific models on collaborative systems are clearly 
...
advanced elaborations with the consequence that he is usually at least 20 years ahead, mostly even more. For our work and research on the 
portal this post must be have been much longer to cover and explain a little bit but  we will keep it for another time and going to mainly 
extract his methods of sonification.


### Generating sound from vision, method of sonification 
The sonification process generated sounds from changes in the image in the short demo-clip on the Nidarø sculpture. 
Changes in a sequence of video images can be temporal or spatial sounds, he chose to map the sequences are inspired by an opera, 
three music instruments are used for melody, chord and drums. To reduce processing Leif measured a subset of pixels. From those in RGB 
format he draw six different variables. The input from the image frames was mapped to operational if-then rules to receive numbers, the 
changes in the intensity measured for a selected set of pixels from one image frame to the next.
...
complementary role towards each other. One of the applied examples of them is  the concept of the travel bureau: 
Beside the near-natural-virtual communication environment through a multi-view perspective on the landscape and happenings of the 

...
Then this data gathered via MFCC is put through various different machine learning algorithms - K Nearest Neighbour, Support Vector Network were the most useful. Support Vector Network achieved the highest, most accurate score (the results are on the front page!)

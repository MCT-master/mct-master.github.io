...
This blog post contains an overview of my master thesis. For more detail explanation, please check my [final report](https://drive.google.com/file/d/1DA7KablpKKwoCuOzADuFrAtE8Y9QA0aN/view?usp=sharing). Digital files associated with the suty including matlab scripts, recorded data and auralized sound files can be found in my github repository titled [Master_Thesis_MCT_2021](https://github.com/shreejayshrestha/Master_Thesis_MCT_2021).

...
The routing and interplay between the LoLa PC with an RME soundcard and the Midas mixer is often the source of trouble in our portal. Therefore, we felt that measures in the shape of another flowchart(!) was needed to highlight this relationship.

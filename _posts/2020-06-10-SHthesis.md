...
### Initial design
In this phase, the device was mostly responsive to the dancer. Although it was designer, so it could be a platform that could be developed further, by the help of co-designer. 
...
<storng>Transition between above the surface and underwater sound</strong> 

<audio controls="controls">
  <source type="audio/mp3" src="/assets/sounds/sepehr/Piano.mp3"></source>
  <p>Your browser does not support the audio element.</p>
</audio>
<storng>Piano sonification</strong> 

<audio controls="controls">
  <source type="audio/mp3" src="/assets/sounds/sepehr/Drums.mp3"></source>
  <p>Your browser does not support the audio element.</p>
</audio>
<storng>Drum sonification</strong> 

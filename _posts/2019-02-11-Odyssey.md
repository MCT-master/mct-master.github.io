...
it. The application is written in HTML5 and javascript. The sounds are taken from <a href="http://freesound.org" target="_blank"></a> while the beautiful picture of the misty jungle has been borrowed from <a href="http://selfgrowth.info/WDF-13569.html" target="_blank"></a>
...
__Want to try it?__ Try it here <a href="http://folk.ntnu.no/shreejas/Odyssey/" target="_blank"></a>

Also you can check the code and related files here in my repository: <a href="http://github.com/shreejayshrestha/Odyssey" target="_blank"></a>

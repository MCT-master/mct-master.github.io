...
it. The application is written in HTML5 and javascript. The sounds are taken from https:freesound.org while the beautiful picture of the misty jungle has been borrowed from www.selfgrowth.info/WDF-13569.html.

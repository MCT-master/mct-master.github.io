...
excerpt: "Odyssey is a simple prototype of a Web Audio Api envisioned to immerse users into a misty jungle with sounds of music and nauture. Besides the jungle environemt, the application adds bits of fun providing sounds of domestic animals like dog, cat and a chicken. The application is written in HTML5 and javascript. The sounds are taken from freesound.org while the beautiful picture of the mistyjungle has been borrowed from www.selfgrowth.info/WDF-13569.html."
---

...
it. The application is written in HTML5 and javascript. The sounds are taken from <a href="http://freesound.org" target="_blank">freesound.org</a> while the beautiful picture of the misty jungle has been borrowed from <a href="http://selfgrowth.info/WDF-13569.html" target="_blank">selfgrowth.info</a>

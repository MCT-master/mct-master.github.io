...
## How to play the API?
The start button triggers a soundscape from a jungle environt and fills in a jazz piece after around 10 seconds. You can press the buttons named 'dog', 'cat', 'chicken' or 'elephant' to play their sounds. There is no any particular sequence of pressing the buttons, so you can experiment with a permutation of 4x4x4x4 ie. in 256 ways.

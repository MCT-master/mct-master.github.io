...
### How to play Odyssey?
The start button triggers a soundscape from a jungle environment and fills in a jazz piece after around 10 seconds. However, you can also press the buttons named 'dog', 'cat', 'chicken' or 'elephant' to play their sounds at any time. Infact, there is no any particular sequence of pressing the buttons. That means you can actually experiment with a permutation of 4! ie. in 24 uni1u3 ways. However, you can repeat it as many times as you like. :stuck_out_tongue_winking_eye:
